...
def load_data():
    ...
    df = df.rename(columns={"date ": "month"}) if "date " in df.columns else df
    ...
    # Validate required socioeconomic columns
    ...
    if required_cols.issubset(df.columns):
        ...
        st.warning("Socioeconomic columns not found. Only basic filters will be available.")
